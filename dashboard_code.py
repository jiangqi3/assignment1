...
def get_pie_chart(entered_site):
   if entered_site == 'ALL':
       ...
       fig = px.pie(filtered_df, values='class', names='Launch Site', title='pie chart of successful launches')
       return fig
   else:
   # return the outcomes piechart for a selected site
       filtered_df = spacex_df[spacex_df["Launch Site"] == str(entered_site)]
       fig = px.pie(filtered_df, names='class', title='pie chart of successful launches')
       return fig
